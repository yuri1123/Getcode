...
<main>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                ...
                <div class="carousel-caption d-flex flex-column justify-content-end">
                  <h1>Make Study</h1>
                  <p>멋진 스터디를 만들어 팀원들과 함께 실력을 향상시켜보아요</p>
                </div>
              </div>
              ...
              <div class="carousel-item">
                ...
                <div class="carousel-caption d-flex flex-column justify-content-end">
                  ...
                  <p>스터디 커뮤니티 공간을 스터디원간의 소통에 활용해 보세요</p>
                </div>
              </div>

              <div class="carousel-item">
                <img src="/resources/yuri/setgoal.jpg"
                     class="carousel-image img-fluid" alt="...">

                <div class="carousel-caption d-flex flex-column justify-content-end">
                  <h1>Project Manage</h1>

                  <p>프로젝트 스터디에서 프로젝트 관리 메뉴를 활용해보세요!</p>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
          <div class="featured-block d-flex justify-content-center align-items-center">
            <a href="kind/donate.html" class="d-block">
              <img src="/resources/yuri/frontend.png" width="40%" class="featured-block-image img-fluid" alt="">
        ...
        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
          <div class="featured-block d-flex justify-content-center align-items-center">
            <a href="kind/donate.html" class="d-block">
              <img src="/resources/yuri/backend.png" width="40%" class="featured-block-image img-fluid" alt="">
        ...
        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
          <div class="featured-block d-flex justify-content-center align-items-center">
            <a href="kind/donate.html" class="d-block">
              <img src="/resources/yuri/smartphone.png" width="40%" class="featured-block-image img-fluid" alt="">
        ...
        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
          <div class="featured-block d-flex justify-content-center align-items-center">
            <a href="kind/donate.html" class="d-block">
              <img src="/resources/yuri/more.png" width="40%" class="featured-block-image img-fluid" alt="">
    ...
    <div class="custom-block-wrap">
      <div class="custom-block">
        <div class="custom-block-body">
          <h5 class="mb-3" style="font-size: 19px; font-weight: bold">율스 자바 스터디</h5>
  ...
  <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
    <div class="custom-block-wrap">
      <div class="custom-block">
        <div class="custom-block-body">
          <h5 class="mb-3" style="font-size: 19px; font-weight: bold">자바스크립트 온라인 스터디</h5>
  ...
  <div class="col-lg-4 col-md-6 col-12">
    <div class="custom-block-wrap">
      <div class="custom-block">
        <div class="custom-block-body">
          <h5 class="mb-3" style="font-size: 19px; font-weight: bold" >무무짱의 신나는 스프링 프로젝트 </h5>
