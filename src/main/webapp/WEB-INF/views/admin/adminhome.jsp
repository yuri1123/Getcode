              ...
              <div class="card h-100">
                <div class="card-header">
                  <ul class="nav nav-pills" role="tablist">
                    ...
                    <li class="nav-item">
                      <button type="button" class="nav-link" role="tab">회원 수</button>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul class="p-0 m-0">
                    ...
                    <li class="d-flex mt-3 mb-3">
                      <div class="avatar flex-shrink-0 me-3">
                        ...
                        <img src="/resources/yuri/backend.png" alt="User" class="rounded" />
                        </c:if>
                        <c:if test="${studyDto.position == 'frontend'}">
                          <img src="/resources/yuri/frontend.png" alt="User" class="rounded" />
                        </c:if>
                        <c:if test="${studyDto.position == 'mobile'}">
                          <img src="/resources/yuri/smartphone.png" alt="User" class="rounded" />
                        </c:if>
                        <c:if test="${studyDto.position == 'etc'}">
                          <img src="/resources/yuri/more.png" alt="User" class="rounded" />
                        </c:if>
                      </div>
                      <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        <div class="me-2">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h3 class="card-title mb-2" style="font-size: 17px">${studyapplyDto.studyname}</h3>
                      <small class="text-center text-dark fw-semibold">${studyapplyDto.regDate} 신청</small><br>
                      <small class="text-center  text-dark fw-semibold">${studyapplyDto.studystart} 시작</small> <br>

                      <input type="hidden" value="${studyapplyDto.id}" id="id">
                      <c:if test="${studyapplyDto.state == 'apply'}">
                        <button type="button" class="btn btn-primary btn-permit mt-3" data-study-id="${studyapplyDto.id}" >승인</button>
                            <button type="button" data-study-id="${studyapplyDto.id}" class="btn btn-dark btn-decline  mt-3" >거절</button>
                      </c:if>
                      <c:if test="${studyapplyDto.state == 'permit'}">
                        <button type="button" class="btn btn-danger btn-restore  mt-3" data-study-id="${studyapplyDto.id}" >승인취소</button>
                      </c:if>
                      <c:if test="${studyapplyDto.state == 'decline'}">
                        <button type="button" class="btn btn-info btn-restore  mt-3" data-study-id="${studyapplyDto.id}" >거절취소</button>
                      </c:if>
                    </div>
                  </div>
                </div>
