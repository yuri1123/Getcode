    ...
    <div class="container">
        <div class="row">
            ...
            <div class="mb-md-5 mt-md-4 pb-5 justify-content-center text-center">
                <form class="custom-form contact-form justify-content-center text-center" action="#" method="post"
                      role="form">
                    ...
                    <form action="${contextPath}/user/login" role="form" method="post">
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${noticelist}" var="list">
                                <tr class="hoverhand" onclick="window.location='${contextPath}/community/noticedetail/${list.id}';">
                                    <td>${list.id}</td>
                                    <td>${list.subject}</td>
