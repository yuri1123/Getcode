...
public class StudyDao {
    ...
    //스터디 생성자로 조회하기
    public List<StudyDto> selectbyme(String createdBy) {
        return sqlSession.selectList(namespace + ".selectbyme", createdBy);
    }
    ...
    public List<StudyDto> selecttopview() {
        return sqlSession.selectList(namespace + ".selecttopview");
    }

    public int createmystudy(UserDto userDto) {
        return sqlSession.insert(namespace + ".createmystudy");
    }

    public String findstudynamebyid(Long id) {
        return sqlSession.selectOne(namespace + ".findstudynamebyid", id);
    }

    public List<Map<String, Object>> countStudyByPosition() {
        return sqlSession.selectList(namespace + ".countstudybyposition");
    }

    public List<Map<String, Object>> countstudybymonth() {
        return sqlSession.selectList(namespace + ".countstudybymonth");
    }
    public int totalstudycount(){return sqlSession.selectOne(namespace+".totalstudycount");}
}
